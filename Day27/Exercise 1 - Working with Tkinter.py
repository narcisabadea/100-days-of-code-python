# Tkinter module is used to create Graphical User Interfaces
...
# The packer is used to place it in the screen and center it automatically
my_label.pack()
...
# Keep the window on screen and listens
window.mainloop()
